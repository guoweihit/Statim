...
#ifndef NFD_DAEMON_TABLE_TIB_HPP
#define NFD_DAEMON_TABLE_TIB_HPP
...
/** \brief represents the Tracing Information Base (TIB)
 */
class Tib : noncopyable
{
public:
  explicit
  Tib(NameTree& nameTree);
...
public: // lookup
  ...
  const Entry*
  findExactMatch(const pit::Entry& pitEntry) const;

public: // mutation
  /** \brief inserts a TIB entry for prefix
   *
...
public: // enumeration
   ...
   *  \warning Undefined behavior may occur if a TIB/PIT/Measurements/StrategyChoice entry
...
#endif // NFD_DAEMON_TABLE_TIB_HPP
